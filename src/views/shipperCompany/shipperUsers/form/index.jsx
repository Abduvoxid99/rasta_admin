...
export default function CreateOperator() {
  ...
  const saveChanges = (data) => {
    ...
    setSaveLoading(true)
    const selectedAction = id ? updateShipperUser(id, data) : postShipperUser(data)
    selectedAction
      .then(() => {
        history.goBack()
      })
  ...
  const routes = [
    {
      title: t("shipper_users"),
      link: true,
      route: `/home/operator/list`,
    },
    {
          ...
          <div className="w-full grid grid-cols-12 gap-4">
            <Card title={t("personal.data")} className="col-span-5">
              <div className="flex items-baseline">
                <span className="w-1/4 input-label">{t("fullName")}</span>
                <div className="w-3/4">
