...
import { deleteNewsletter, getNewsletter } from "../../../services/push"
...
export default function BannersTable({ permissions }) {
  ...
  const handleDeleteItem = () => {
    ...
    deleteNewsletter(deleteModal.id)
      .then(() => {
        getItems(currentPage)
  ...
  const columns = [
    ...
    // },
    {
      title: t("Тип получателя"),
      key: "receiver_type",
      render: (record) => t(record.receiver_type),
    },
    // {
    //   title: "",
    //   key: "actions",
              ...
              {items.data &&
                ...
                items.data.map((item, index) => (
                  <TableRow
                    ...
                    onClick={() => {
                      permissions.put &&
                        history.push(`/home/marketing/newsletter/${item.id}`)
                    }}
                  >
                    {columns.map((col) => (
