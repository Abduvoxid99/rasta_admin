...
export default function App({ routes = [], isShowBack = true, backWithUrl }) {
  ...
  return (
    <div className="flex">
      ...
      {routes.map((el, i) => (
        <div key={"bredcrumb-" + i} className="flex items-center text-sm">
          <div className="flex justify-start rounded items-center w-22 ">
            ...
            {routes.length !== i + 1 ? (
              ...
              <span className="px-1 block truncate w-52">{el.title}</span>
            )}
